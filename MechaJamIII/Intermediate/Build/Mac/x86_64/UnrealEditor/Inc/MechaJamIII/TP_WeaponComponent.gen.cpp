...
#include "MechaJamIII/TP_WeaponComponent.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeTP_WeaponComponent() {}
// Cross Module References
	MECHAJAMIII_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
	MECHAJAMIII_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
...
// End Cross Module References
	...
	{
		P_GET_OBJECT(AMechaJamIIICharacter,Z_Param_TargetCharacter);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
	{
		...
		{
			AMechaJamIIICharacter* TargetCharacter;
		};
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTP_WeaponComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 3129348026
	...
	template<> MECHAJAMIII_API UClass* StaticClass<UTP_WeaponComponent>()
	{
		return UTP_WeaponComponent::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UTP_WeaponComponent);
	struct Z_CompiledInDeferFile_FID_MechaJamIII_Source_MechaJamIII_TP_WeaponComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MechaJamIII_Source_MechaJamIII_TP_WeaponComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTP_WeaponComponent, UTP_WeaponComponent::StaticClass, TEXT("UTP_WeaponComponent"), &Z_Registration_Info_UClass_UTP_WeaponComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_WeaponComponent), 3877845108U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MechaJamIII_Source_MechaJamIII_TP_WeaponComponent_h_4195815497(TEXT("/Script/MechaJamIII"),
		Z_CompiledInDeferFile_FID_MechaJamIII_Source_MechaJamIII_TP_WeaponComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MechaJamIII_Source_MechaJamIII_TP_WeaponComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
